...
<?php endif; ?>
    <div class="comment-container">
        <?php printf(__('<cite class="fn comment-name">%s</cite>'), get_comment_author_link()) ?>
      <div class="comment-meta commentmetadata"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>">
          <?php
              printf( __('%1$s at %2$s'), get_comment_date(),  get_comment_time()) ?></a><?php edit_comment_link(__('<span class="separator">&bull;</span> Edit'),'  ','' );
          ?>
      </div>

      <?php comment_text() ?>

      <div class="reply view-article">
...
add_filter( 'the_content_more_link', 'html5_blank_view_article' );
